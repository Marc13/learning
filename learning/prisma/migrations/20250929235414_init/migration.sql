...
-- CreateIndex
CREATE UNIQUE INDEX "NoteTags_noteId_tagId_key" ON "public"."NoteTags"("noteId", "tagId");
...
-- AddForeignKey
ALTER TABLE "public"."NoteTags" ADD CONSTRAINT "NoteTags_noteId_fkey" FOREIGN KEY ("noteId") REFERENCES "public"."Note"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "public"."NoteTags" ADD CONSTRAINT "NoteTags_tagId_fkey" FOREIGN KEY ("tagId") REFERENCES "public"."Tag"("id") ON DELETE CASCADE ON UPDATE CASCADE;
